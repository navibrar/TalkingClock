...
struct Alarm: PropertyReflectable {
    ...
    init(date:Date, enabled:Bool, snoozeEnabled:Bool, repeatWeekdays:[Int], uuid:String, mediaID:String, mediaLabel:String, label:String, onSnooze: Bool, featureEnabled: Bool, reminderEnabled: Bool){
        self.date = date
    ...
    init(_ dict: PropertyReflectable.RepresentationType){
        ...
        featureEnabled = dict["featureEnabled"] as! Bool
